...
src\main.py:126: error: Function is missing a type annotation for one or more arguments  [no-untyped-def]src\main.py:138: error: Function is missing a type annotation  [no-untyped-def]
