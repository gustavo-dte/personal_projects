...
# MESSAGE PROCESSING
# --------------------------------------------------------------------------
def process_subscription_messages(client, topic, subscription, dest_conn, direction, logger):
...
def orchestrate_replication(source_message, config: ReplicationConfig, topic_name: str) -> None:
    ...
    def send_with_retry(correlation_id=None):
        replicate_message_to_destination(source_message, dest_conn, dest_topic, direction, correlation_id)
...
# CORE REPLICATION
# --------------------------------------------------------------------------
def replicate_message_to_destination(source_message, dest_conn, dest_topic, direction, correlation_id):
