...
ENV_PRIMARY_TOPIC_NAME = "PRIMARY_TOPIC_NAME"
ENV_SECONDARY_TOPIC_NAME = "SECONDARY_TOPIC_NAME"
ENV_PRIMARY_SUBSCRIPTION_PRINCIPAL_NAME = "TOPIC_PRIMARY_SUBSCRIPTION_A"
ENV_PRIMARY_SUBSCRIPTION_ADDITIONAL_NAME = "TOPIC_PRIMARY_SUBSCRIPTION_B"
