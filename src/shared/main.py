...
from src.shared.config import ReplicationConfig
...
from src.shared.message_utils import create_replicated_message, generate_correlation_id
...
def configure_application_logging(config: ReplicationConfig) -> logging.Logger:
    ...
    """
    logger: logging.Logger = configure_logger(config)
    return logger
