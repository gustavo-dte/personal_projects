...
ENV_PRIMARY_SUBSCRIPTION_PRINCIPAL_NAME = "PRIMARY_SUBSCRIPTION_PRINCIPAL_NAME"
ENV_PRIMARY_SUBSCRIPTION_ADDITIONAL_NAME = "PRIMARY_SUBSCRIPTION_ADDITIONAL_NAME"
ENV_SUBSCRIPTION_LIST = "SUBSCRIPTION_LIST"
