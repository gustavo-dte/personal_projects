...
# Replication types
REPLICATION_TYPE_PRIMARY_TO_SECONDARY = "primary_to_secondary"
REPLICATION_TYPE_SECONDARY_TO_PRIMARY = "secondary_to_primary"

# Default values
DEFAULT_REPLICATION_TYPE = REPLICATION_TYPE_PRIMARY_TO_SECONDARY
