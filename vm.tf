...
resource "azurerm_windows_virtual_machine" "main" {
  ...
  # Patch management is handled via azurerm_maintenance_configuration resources
  # These parameters cannot be set when using os_managed_disk_id (attach mode)
  # The VM is already configured in Azure Update Manager from VMware cutover
...
resource "azurerm_linux_virtual_machine" "main" {
  ...
  # Patch management is handled via azurerm_maintenance_configuration resources
  # This parameter cannot be set when using os_managed_disk_id (attach mode)
  # The VM is already configured in Azure Update Manager from VMware cutover
