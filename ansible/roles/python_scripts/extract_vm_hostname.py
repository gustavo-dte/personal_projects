...
def _write_github_env(github_env: Optional[str], key: str, value: str) -> None:
    ...
    Args:
        ...
        key:        Environment variable name to assign.
...
def run(manifest_file: str, github_env: Optional[str]) -> None:
    ...
    # Only add domain suffix if hostname doesn't already include a domain
    if "." in hostname:
        # Hostname already includes domain (e.g., "dca-tst1856.dtenet.com")
        vm_fqdn = hostname
    else:
        # Hostname is short name (e.g., "dca-tst1856"), append domain suffix
