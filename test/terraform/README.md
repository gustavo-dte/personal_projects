...
| Name | Description |
|------|-------------|
| <a name="output_application_resource_groups"></a> [application\_resource\_groups](#output\_application\_resource\_groups) | Application resource groups created for CorpApps portfolio test environment |
<!-- END_TF_DOCS -->
