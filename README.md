...
| <a name="input_patch_assessment_schedule"></a> [patch\_assessment\_schedule](#input\_patch\_assessment\_schedule) | Configuration for periodic update assessment schedule. Only applies when enable\_periodic\_update\_assessment is true. | <pre>object({<br/>    frequency   = optional(string, "Daily")<br/>    time_of_day = optional(string, "02:00")<br/>  })</pre> | <pre>{<br/>  "frequency": "Daily",<br/>  "time_of_day": "02:00"<br/>}</pre> | no |
